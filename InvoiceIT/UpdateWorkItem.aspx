...
<body>
    <div id="frmcontWorkItem" runat="server">
    <form id="UpdateNewWorkItem" runat="server">
            ...
            <div class="add-work-item-page-content">
                ...
                <div class="row-with-textboxes">
                    <div class="textbox-label-general-purpose">
                        ...
                        <asp:Literal ID="StartTimePH" runat="server"></asp:Literal>
                    </div>
                    <div class="textbox-label-general-purpose">
                ...
                <div class="row-with-textboxes">
                    <div class="textbox-label-general-purpose">
                        ...
                        <asp:Literal ID="EndTimePH" runat="server"></asp:Literal>
                    </div>
                    <div class="textbox-label-general-purpose">
                ...
                <div class="add-work-item-button-container">
                    <div class="button-two-row">
                        <asp:Button ID="BtnUpdateWorkItem" class="submit-button" runat="server" OnClick="BtnUpdateWorkItem_Click" Text="Update work item" />
                    </div>
                    <div class="button-one-row">
                        <asp:LinkButton ID="BtnBackToMenu" class="back-button" href="ViewWorkItemList.aspx" runat="server">Back to menu</asp:LinkButton>
                    </div>
